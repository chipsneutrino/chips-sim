...
int main(int argc, char** argv) {
	...
	WCSimCherenkovBuilder* WCSimdetector = new WCSimCherenkovBuilder(WCSimConfiguration);
	...
	// Set up the messenger hooks here, initialise the actual list after loading jobOptions.mac
