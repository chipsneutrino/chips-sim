...
class WCSimPrimaryGeneratorAction: public G4VUserPrimaryGeneratorAction {
	...
	public:
		...
		WCSimTruthSummary* GetTruthSummaryPointer() {
		...
		void SetRandomVertex(bool val) {
			fUseRandomVertex = val;
		}

		bool GetRandomVertex() {
			return fUseRandomVertex;
		}

		void SetFiducialBorder(double val) {
			fFidBorder = val;
		}

		bool GetFiducialBorder() {
			return fFidBorder;
		}

		// Swap X and Z coordinates for events generated with GENIE
		void SetUseXAxisForBeam(bool val) {
			fUseXAxisForBeam = val;
		}

		bool GetUseXAxisForBeam() {
			return fUseXAxisForBeam;
		}
	...
	private:
		...
		void FireParticleGunFromTrackLine(G4Event *evt, G4ThreeVector &vtx, double& vtxTime,
