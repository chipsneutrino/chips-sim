...
public:
	...
	std::string GetCellPMTName(WCSimGeometryEnums::DetectorRegion_t region, int zone, unsigned int pmt) const;
	std::vector<std::string> GetCellPMTName(WCSimGeometryEnums::DetectorRegion_t region, int zone) const;
	...
	void AddCellPMTFaceType(WCSimGeometryEnums::DetectorRegion_t region, int zone,
	...
	std::vector<WCSimGeometryEnums::PMTDirection_t> GetCellPMTFaceType(WCSimGeometryEnums::DetectorRegion_t region,
																	   int zone) const;
