...
// Get/Set functions 
  ...
  inline G4double GetWavelength() const 
   { return (2.0*M_PI*197.3)/(fEnergy/eV); }
...
// AJP added for making optical photon ntuple
  inline G4bool IsOpticalPhoton() const { return fIsOpticalPhoton; }
  inline G4bool IsScatteredPhoton() const { return fIsScatteredPhoton; }
