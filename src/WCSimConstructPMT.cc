...
//  G4double PMTHolderR[2] = {WCPMTRadius, WCPMTRadius};
	...
	solidWCPMT = new G4Polycone("WCPMT", 0.0 * deg, 360.0 * deg, 2, PMTHolderZ, PMTHolderR, PMTHolderr);
	...
	G4Sphere* tmpSolidInteriorWCPMT = new G4Sphere("tmpInteriorWCPMT", 0.0 * m,
			(sphereRadius - fPMTConfigs[0].GetGlassThickness()), 0.0 * deg, 360.0 * deg, 0.0 * deg, 90.0 * deg);
