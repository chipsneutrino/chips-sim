...
void WCSimGeoConfig::SetLimitPMTNumbers(bool doIt) {
	if (fPMTLimit != WCSimGeometryEnums::PhotodetectorLimit_t::kUnknown
			&& fPMTLimit != WCSimGeometryEnums::PhotodetectorLimit_t::kTotalNumber && doIt) {
...
void WCSimGeoConfig::SetUseOverallCoverage(bool doIt) {
	if (fPMTLimit != WCSimGeometryEnums::PhotodetectorLimit_t::kUnknown
			&& fPMTLimit != WCSimGeometryEnums::PhotodetectorLimit_t::kPercentCoverage && doIt) {
...
void WCSimGeoConfig::SetUseZonalCoverage(bool doIt) {
	if (fPMTLimit != WCSimGeometryEnums::PhotodetectorLimit_t::kUnknown
			&& fPMTLimit != WCSimGeometryEnums::PhotodetectorLimit_t::kZonalCoverage && doIt) {
		std::cerr << "Error: can't set photodetector limit to a fixed global coverage - is already set to "
				<< fPMTLimit.AsString();
	}
	if (doIt) {
