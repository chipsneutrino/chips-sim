...
WCSimTrajectory::WCSimTrajectory() :
		positionRecord(0), fTrackID(0), fParentID(0), fProcessID(0), PDGEncoding(0), PDGCharge(0.0), ParticleName(""), initialMomentum(
				G4ThreeVector()), fEnergy(0.0), fParticleDirection(G4ThreeVector()), fParticlePosition(G4ThreeVector()), fVtxX(
				0.0), fVtxY(0.0), fVtxZ(0.0), fVtxDirX(0.0), fVtxDirY(0.0), fVtxDirZ(0.0), fIsOpticalPhoton(false), fIsScatteredPhoton(
				false), SaveIt(false), creatorProcess(""), globalTime(0.0) {
	;
}
